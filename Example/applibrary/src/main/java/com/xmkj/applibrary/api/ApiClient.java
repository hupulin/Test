...
public class ApiClient {
    ...
    //    private String baseUrl = "https://course.chongxuebang.com/api/";//正式
    String baseUrl = "http://test-course.chongxuebang.com/api/";//测试
...
//              .addHeader("Authorization", "Bearer "+ SpUtil.getString("Token"))
                .addHeader("X-Client-AppKey", "02b823f5ac204e819a02cbe33f256406")
//                .addHeader("X-Group-Key", "1".equals(SpUtil.getString("role")) ? "" : TextUtils.isEmpty(SpUtil.getString("shopToken")) ? "" : SpUtil.getString("shopToken"))
                .addHeader("Authorization", (TextUtils.isEmpty(SpUtil.getString("Token"))) ? "" : ("Bearer " + SpUtil.getString("Token")))
                .build());
...
//                .sslSocketFactory(getSSLSocketFactory(mContext, certificates))
                ...
                .hostnameVerifier((hostname, session) -> "course.chongxuebang.com".equals(hostname))
...
//        String baseUrl ="http://test-course.chongxuebang.com/api/";
//        String baseUrl ="http://47.92.236.248:9002/";
//        String baseUrl ="http://192.168.1.28:9001/";
