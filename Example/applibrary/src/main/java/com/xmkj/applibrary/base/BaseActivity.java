...
import com.xmkj.applibrary.base.photopick.Image;
...
import com.xmkj.applibrary.base.photopick.SelectModel;
import com.xmkj.applibrary.base.photopick.intent.PhotoPickerIntent;
import com.xmkj.applibrary.base.photopick.intent.PhotoPreviewIntent;
import com.xmkj.applibrary.base.view.RecycleViewHeadView;
import com.xmkj.applibrary.domain.MessageTo;

import com.xmkj.applibrary.impl.FragmentPermissionListener;
import com.xmkj.applibrary.impl.PermissionListener;
import com.xmkj.applibrary.util.GetPathFromUri;
...
//        EventBus.getDefault().unregister(this);
    ...
    protected void setPostImageLayout(GridLayout itemImageLayout, int width, int num) {
        ...
        for (int i = 0; i < (imagePaths.size() == num ? num : imagePaths.size() + 1) && i < num; i++) {
            ...
            layoutParams.setMargins(0, 0, (int) (28.0 / 750 * getScreenWidth()), (int) (20.0 / 750 * getScreenWidth()));
